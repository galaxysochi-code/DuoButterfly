...
"title": "DUO Butterfly — эффект крышки MacBook для macOS",
...
"motionCopy": "DUO Butterfly считывает датчик угла крышки и перерисовывает рабочий стол при каждом её положении. Это не записанная заранее анимация.",
...
"title": "DUO Butterfly — Efecto de tapa de MacBook para macOS",
...
"motionCopy": "DUO Butterfly lee el sensor de ángulo de la tapa y vuelve a dibujar el escritorio en cada posición. No es una animación pregrabada.",
...
"control1": "Ajusta el efecto",
"control2": "desde la barra de menús.",
...
"title": "DUO Butterfly — MacBook 合盖桌面特效 · macOS 应用",
...
"motion1": "合上屏幕盖。",
"motion2": "桌面随之变化。",
"motionCopy": "DUO Butterfly 读取屏幕盖角度传感器，在每个角度实时重新绘制桌面，而不是播放预录动画。",
